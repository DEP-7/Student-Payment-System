...
public class CourseServiceTest {
    ...
    public static void updateCourse() throws NotFoundException, FailedOperationException {
        Course course1 = new Course("DEP1", "DEP", 100000, 2, 30, "4 Months", "2 Weeks", "2 Montshs", "Available", null, " (A) 3 or 4 years Bachelor Degree in any stream which includes 3 main IT subjects OR,\n" + "\n" + "(B) HND in Computing (or IT related) OR,\n" + "\n" + "(C) Any equivalent or higher education qualification acceptable by the IJSE (The candidate will have to face an interview in order to be selected to the programme)", "Lecturer Name : Mr. Ranjith Suranga\nContact : 071 000 0000", LocalDate.of(2015, 4, 11));
    ...
    public static void deleteCourse() throws NotFoundException, FailedOperationException {
